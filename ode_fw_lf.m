...
%% LF step for forcing terms
coeff1 = 1/rho_air/Ha/Crhoa;
Tnew = T_old + 2*coeff1*dt.*(QSSW - QLW + QRR +...
   QSH + QLH);
coeff2 = 1/rho_air/Hq;
Qnew = Q_old + 2*coeff2*dt.*rho_sea.*(sea.*EVAP-PRECIP)./31536000;
%% end LF step
